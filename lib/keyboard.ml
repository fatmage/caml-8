...
let rec handle_events : events -> events = fun curr_events ->
  ...
  if Sdl.poll_event (Some event) then begin
    ...
    | `Key_up -> 
      let scancode = Sdl.Event.(get event keyboard_scancode) in
      begin match Sdl.Scancode.enum scancode with 
      | `K1     -> {curr_events with keypad_up =  (U8.of_int 0x1) :: curr_events.keypad_up} |> handle_events 
      | `K2     -> {curr_events with keypad_up =  (U8.of_int 0x2) :: curr_events.keypad_up} |> handle_events 
      | `K3     -> {curr_events with keypad_up =  (U8.of_int 0x3) :: curr_events.keypad_up} |> handle_events 
      | `K4     -> {curr_events with keypad_up =  (U8.of_int 0xC) :: curr_events.keypad_up} |> handle_events 
      | `Q      -> {curr_events with keypad_up =  (U8.of_int 0x4) :: curr_events.keypad_up} |> handle_events 
      | `W      -> {curr_events with keypad_up =  (U8.of_int 0x5) :: curr_events.keypad_up} |> handle_events 
      | `E      -> {curr_events with keypad_up =  (U8.of_int 0x6) :: curr_events.keypad_up} |> handle_events 
      | `R      -> {curr_events with keypad_up =  (U8.of_int 0xD) :: curr_events.keypad_up} |> handle_events 
      | `A      -> {curr_events with keypad_up =  (U8.of_int 0x7) :: curr_events.keypad_up} |> handle_events 
      | `S      -> {curr_events with keypad_up =  (U8.of_int 0x8) :: curr_events.keypad_up} |> handle_events 
      | `D      -> {curr_events with keypad_up =  (U8.of_int 0x9) :: curr_events.keypad_up} |> handle_events 
      | `F      -> {curr_events with keypad_up =  (U8.of_int 0xE) :: curr_events.keypad_up} |> handle_events 
      | `Z      -> {curr_events with keypad_up =  (U8.of_int 0xA) :: curr_events.keypad_up} |> handle_events 
      | `X      -> {curr_events with keypad_up =  (U8.of_int 0x0) :: curr_events.keypad_up} |> handle_events 
      | `C      -> {curr_events with keypad_up =  (U8.of_int 0xB) :: curr_events.keypad_up} |> handle_events 
      | `V      -> {curr_events with keypad_up =  (U8.of_int 0xF) :: curr_events.keypad_up} |> handle_events 
